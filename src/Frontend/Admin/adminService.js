document.addEventListener("DOMContentLoaded", function () {
    ...
    function openEditOverlay(service) {
        ...
        editServiceImagePreview.src = `http://localhost:3000/${service.image}`;
    ...
    editServiceImageInput.addEventListener("change", function () {
        ...
        if (file) {
            if (!validateImageType(file)) {
                alert("Only images in JPEG, JPG, or PNG formats are allowed");
                editServiceImageInput.value = "";
                editServiceImagePreview.src = `http://localhost:3000/${existingImagePath}`;
    ...
    addServiceForm.addEventListener("submit", function (e) {
        ...
        fetchWithRetry("http://localhost:3000/api/add-service", {
            method: "POST",
            body: formData,
        })
            .then(data => {
    ...
    editServiceForm.addEventListener("submit", function (e) {
        ...
        fetchWithRetry(`http://localhost:3000/api/update-service/${currentServiceId}`, {
            method: "PUT",
            body: formData,
        })
            .then(data => {
    ...
    async function fetchServices(searchQuery = "") {
        ...
        try {
            const services = await fetchWithRetry("http://localhost:3000/api/services", {
                method: "GET",
            });
            ...
            if (filteredServices.length === 0) {
                    ...
                    row.innerHTML = `
                        ...
                        <td>
                            <div class="service-name">
                                <img src="http://localhost:3000/${service.image}" alt="${service.name}" class="service-image">
                ...
                document.querySelectorAll(".edit-button").forEach(button => {
                    button.addEventListener("click", function () {
                        ...
                        fetchWithRetry(`http://localhost:3000/api/service/${serviceId}`, {
                            method: "GET",
                        })
                            .then(service => {
                ...
                document.querySelectorAll(".delete-button").forEach(button => {
                    button.addEventListener("click", function () {
                        ...
                        if (confirm("Are you sure you want to delete this service?")) {
                            fetchWithRetry(`http://localhost:3000/api/delete-service/${serviceId}`, {
                                method: "DELETE",
                            })
                                .then(data => {

document.addEventListener("DOMContentLoaded", function () {
    ...
    function openEditOverlay(category) {
        ...
        editCategoryImagePreview.src = `http://localhost:3000/${category.image}`;
    ...
    editCategoryImageInput.addEventListener("change", function () {
        ...
        if (file) {
            if (!validateImageType(file)) {
                ...
                editCategoryImagePreview.src = `http://localhost:3000/${existingImagePath}`;
    ...
    addCategoryForm.addEventListener("submit", function (e) {
        ...
        fetchWithRetry("http://localhost:3000/api/add-category", {
            method: "POST",
            body: formData,
        })
            .then(data => {
    ...
    editCategoryForm.addEventListener("submit", function (e) {
        ...
        fetchWithRetry(`http://localhost:3000/api/update-category/${currentCategoryId}`, {
            method: "PUT",
            body: formData,
        })
            .then(data => {
            ...
            if (filteredCategories.length === 0) {
                    ...
                    row.innerHTML = `
                        ...
                        <td>
                            <div class="category-name">
                                <img src="http://localhost:3000/${category.image}" alt="${category.name}" class="category-image">
                ...
                document.querySelectorAll(".edit-button").forEach(button => {
                    button.addEventListener("click", function () {
                        ...
                        fetchWithRetry(`http://localhost:3000/api/category/${categoryId}`, {
                            method: "GET",
                        })
                            .then(category => {
                ...
                document.querySelectorAll(".delete-button").forEach(button => {
                    button.addEventListener("click", function () {
                        ...
                        if (confirm("Are you sure you want to delete this category?")) {
                            fetchWithRetry(`http://localhost:3000/api/delete-category/${categoryId}`, {
                                method: "DELETE",
                            })
                                .then(data => {
